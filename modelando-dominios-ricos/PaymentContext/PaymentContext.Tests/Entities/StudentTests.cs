...
namespace PaymentContext.Tests
{
    ...
    public class StudentTests
    {
        ...
        public StudentTests()
        {
            ...
            _document = new Document("12857944004", EDocumentType.CPF);
        ...
        {
            _student.ClearSubscription();
            _subscription.ClearPayment();
        ...
        [TestMethod]
        public void ShouldReturnErrorWhenHadSubscriptionHasNoPayemnt()
        {
            _student.ClearSubscription();
            _subscription.ClearPayment();
